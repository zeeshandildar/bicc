          ...
          <div className={styles.discoveryGrid}>
            {[
              ...
              },
              {
                ...
                desc: t('Meet the diverse family of 20+ nations that makes BICC special.', 'Conoce a la diversa familia de más de 20 naciones que hace especial al BICC.'),
                link: '/members',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '60px', alignItems: 'center' }}>
            <ScrollAnimation>
              <h2 className="bebas" style={{ fontSize: '3.5rem', lineHeight: '1', marginBottom: '24px' }}>
                {t('More Than Just', 'Más que')} <br /> <span className="gradient-gold">{t('A Cricket Club', 'un club de críquet')}</span>
              </h2>
              ...
              <div style={{ display: 'flex', gap: '20px' }}>
                ...
                <Link href="/contact" className="btn-premium btn-gold">{t('Contact Us', 'Contáctanos')}</Link>
              </div>
            </ScrollAnimation>
          ...
          <ScrollAnimation>
            <div className={`glass-panel ${styles.ctaPanel}`}>
              ...
              <Link href="/join" className="btn-premium btn-red" style={{ padding: '20px 48px', fontSize: '1.1rem' }}>
                {t('Start Your Application', 'Empieza tu solicitud')}
              </Link>
            </div>
          </ScrollAnimation>
        </div>

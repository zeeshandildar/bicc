...
export function getNotificationConfig() {
  return {
    ...
    notificationEmails: Array.isArray(notificationConfig.notificationEmails)
      ...
      : [],
    eventRecipients: notificationConfig.eventRecipients || {},
...
export async function sendWebhookNotification({ eventType, data }) {
  ...
  const eventRecipients = config.eventRecipients[eventType];
  const recipients = Array.isArray(eventRecipients) && eventRecipients.length
    ? eventRecipients
